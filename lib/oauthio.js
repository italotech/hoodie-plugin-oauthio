...
module.exports = function (hoodie) {
  ...
  queryByEmail = function(task, cb) {
    return pluginDb.query('by_email', {key: task.email}, function (err, rows) {
  ...
  updateProvider = function(task, cb) {
    ...
    pluginDb.update(task.provider, task.pluginId, { hoodieId: task.hoodieId }, function (err, _doc) {
